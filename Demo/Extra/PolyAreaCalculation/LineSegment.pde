class LineSegment { 
  ...
  public boolean Crosses(final LineSegment ls) {    
    ...
    final float cross_p1p2_p1p3 = p1p2.CrossProduct(p1p3);    
    final float cross_p1p2_p1p4 = p1p2.CrossProduct(p1p4);
    final boolean bp1p2 = (cross_p1p2_p1p3 * cross_p1p2_p1p4) < -0.0f;
    
    // 2nd case - both points (p1, p2) should lay on the different sides of <p3p4>
    // this far their cross products product should be negative
    
    final float cross_p3p4_p3p1 = p3p4.CrossProduct(p3p1);    
    final float cross_p3p4_p3p2 = p3p4.CrossProduct(p3p2);
    final boolean bp3p4 = (cross_p3p4_p3p1 * cross_p3p4_p3p2) < -0.0f;
    
    return bp1p2 && bp3p4;
  }
  public Point CrossPointOf(final LineSegment ls) { 
