	...
	struct ContentLoader
	{
		...
		*/
		void UploadShape(
			...
			_In_ String const &targetShape,					//!< \param [in] targetShape Shape node name \example "pCubeShape1" or "pCubeShape1Orig"
			...
			_In_ String const &targetJointSematicName,		//!< \param [in] targetJointSematicName Joint name first letters \example "joint"
