...
namespace Sandbox
{
	...
	namespace Rendering
	{
		...
		typedef D3D11_UNORDERED_ACCESS_VIEW_DESC UnorderedAccessViewDescription;
		typedef D3D11_SHADER_RESOURCE_VIEW_DESC ShaderResourceViewDescription;
		...
		typedef Texture3::InterfaceType *Texture3Ptr;
