...
inline void BasicLoader::SetResourceDebugName(
    ...
    )
{
    ...
    SetResourceDebugName(texture2D.Get(), debugName);
    ...
    )
{
    ...
    SetResourceDebugName(*vertexBuffer, Platform::String::Concat(debugName, "_VertexBuffer"));
    SetResourceDebugName(*indexBuffer, Platform::String::Concat(debugName, "_IndexBuffer"));
    ...
    )
{
    ...
    SetResourceDebugName(*shader, filename);
    ...
    if (layout != nullptr)
    {
        ...
        SetResourceDebugName(*layout, filename);
    }
}
