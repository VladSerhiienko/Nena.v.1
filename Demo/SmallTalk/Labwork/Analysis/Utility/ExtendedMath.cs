...
namespace SmallTalk.Labwork.Analysis
{
    public static partial class Statistics
    {
        ...
        public static double Factorial(double x)
        {
            ...
            else return GammaFunction(x + 1.0);
        }
        ...
        public static double IncompleteBetaFunction(double z, double a, double b)
        {
            return Math.Pow(z, a) / a * GaussHypergeometricFunction(a, 1 - b, a + 1, z); //, 15);
        }
        ...
        public static double GaussHypergeometricFunction(double a, double b, double c, double z, double e = 1e-5)
        {
            if (c < 0.0) throw new ArithmeticException("GaussHypergeometricFunction: Undefined.");
            if (Math.Abs(z) > 1) throw new ArithmeticException("GaussHypergeometricFunction: Unstable condition.");
            if (a < 0.0 || b < 0.0) throw new ArithmeticException("GaussHypergeometricFunction: Complex infinity.");
            ...
            var n = 0; do
            {
                temp = PochhammerSymbol(a, n);
                temp /= PochhammerSymbol(c, n);
                temp *= PochhammerSymbol(b, n);
                temp /= Factorial(n);
                temp *= Math.Pow(z, n);
            ...
            System.Diagnostics.Debug.WriteLine("2F1: N=" + n + " Lt=" + temp);
            return result;
        }

        public static double GaussHypergeometricFunction(double a, double b, double c, double z, int precision, double e = 1e-5)
        {
            if (c < 0.0) throw new ArithmeticException("GaussHypergeometricFunction: Undefined.");
            if (Math.Abs(z) > 1) throw new ArithmeticException("GaussHypergeometricFunction: Unstable condition.");
            if (a < 0.0 || b < 0.0) throw new ArithmeticException("GaussHypergeometricFunction: Complex infinity.");
            ...
            var n = 0; do
            {
                ...
                if (n >= precision)
                {
                    //System.Diagnostics.Debug.Write("(Precision " + n + ")");
                    break;
                }
        ...
        public static double GammaFunction(double x)
        {
            ...
            if (q > 33.0)
            {
                if (x < 0.0)
                {
                    ...
                    if (p == q) throw new ArithmeticException("GammaFunction: Overflow.");
                    ...
                    if (z == 0.0) throw new ArithmeticException("GammaFunction: Overflow.");

                    z = Math.Abs(z);
                    z = Math.PI / (z * StirlingGammaFunction(q));
                    return -z;
                }
                else
                {
                    return StirlingGammaFunction(x);
                }
            }
            ...
            while (x < 0.0)
            {
                if (x == 0.0) throw new ArithmeticException("GammaFunction: Singular.");
                else if (x > -1.0E-9) return (z / ((1.0 + 0.5772156649015329 * x) * x));
        ...
        /// <summary> Return the gamma function computed by Stirling's formula.</summary>
        private static double StirlingGammaFunction(double x)
        {
            double[] STIR = 
            {
        ...
        public static double ComplementaryIncompleteGammaFunction(double a, double x)
        {
            ...
            if (x < 1.0 || x < a) return 1.0 - IncompleteGammaFunction(a, x);
        ...
        public static double IncompleteGammaFunction(double a, double x)
        {
            ...
            if (x > 1.0 && x > a) return 1.0 - ComplementaryIncompleteGammaFunction(a, x);
        ...
        **/
        ...
        public static double ChiSquaredFunctionLeftTail(double df, double x)
        {
            if (x < 0.0 || df < 1.0) return 0.0;
            return IncompleteGammaFunction(df / 2.0, x / 2.0);
        }
        ...
        **/
        ...
        /// <param name="df">Degrees of freedom.</param>
        /// <param name="x">Double value.</param>
        public static double ChiSquaredFunctionRightTail(double df, double x)
        {
            if (x < 0.0 || df < 1.0) return 0.0;
            return ComplementaryIncompleteGammaFunction(df / 2.0, x / 2.0);
        }




        /// <summary>Returns the complementary error function of the specified number.</summary>
        ...
        /// <summary>Returns the error function of the specified number.</summary>
        ...
        public static double ErrorFunction(double x)
        {
            ...
            if (Math.Abs(x) > 1.0) return (1.0 - ComplementaryErrorFunction(x));
            z = x * x;
        ...
        /// <param name="xx"></param>
        /// <returns></returns>
        public static double Asinh(this double xx)
        {
            double x;
            int sign;
            if (xx == 0.0) return xx;
        ...
        {
            if (x > 1.0 || x < -1.0) throw new ArithmeticException("range exception");
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public static double BesselFunctionOrder0(this double x)
        {
            double ax;
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public static double BesselFunctionOrder1(this double x)
        {
            double ax;
            double y;
            double ans1, ans2;
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public static double BesselFunctionOrderN(int n, double x)
        {
            int j, m;
            ...
            if (n == 0) return BesselFunctionOrder0(x);
            if (n == 1) return BesselFunctionOrder1(x);
            ...
            {
                tox = 2.0 / ax;
                bjm = BesselFunctionOrder0(ax);
                bj = BesselFunctionOrder1(ax);
                for (j = 1; j < n; j++)
                {
                    bjp = j * tox * bj - bjm;
                    bjm = bj;
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public static double Bessel2ndFunctionOrder0(double x)
        {
            if (x < 8.0)
            {
                double y = x * x;
                ...
                return (ans1 / ans2) + 0.636619772 * BesselFunctionOrder0(x) * Math.Log(x);
            }
            else
            {
                double z = 8.0 / x;
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public static double Bessel2ndFunctionOrder1(double x)
        {
            if (x < 8.0)
            {
                double y = x * x;
                ...
                return (ans1 / ans2) + 0.636619772 * (BesselFunctionOrder1(x) * Math.Log(x) - 1.0 / x);
            }
            else
            {
                double z = 8.0 / x;
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public static double Bessel2ndFunctionOrderN(int n, double x)
        {
            double by, bym, byp, tox;

            if (n == 0) return Bessel2ndFunctionOrder0(x);
            if (n == 1) return Bessel2ndFunctionOrder1(x);

            tox = 2.0 / x;
            by = Bessel2ndFunctionOrder1(x);
            bym = Bessel2ndFunctionOrder0(x);
            for (int j = 1; j < n; j++)
            {
                byp = j * tox * by - bym;
                bym = by;
        ...
        /// <param name="xx"></param>
        /// <returns></returns>
        public static double IncompleteBetaFunction1(double aa, double bb, double xx)
        {
        ...
        public static double poisson(int k, double x)
        {
            ...
            return ComplementaryIncompleteGammaFunction((double)(k + 1), x);
        }
        ...
        public static double poissonc(int k, double x)
        {
            ...
            return IncompleteGammaFunction((double)(k + 1), x);
        }
        ...
        public static double normal(double a)
        {
            ...
            {
                y = 0.5 * ComplementaryErrorFunction(z);
                if (x > 0) y = 1.0 - y;
            }
