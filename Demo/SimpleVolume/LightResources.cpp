...
void Demo::LightResources::Update(Nena::Matrix *focus, Demo::Light *light)
{
	...
	LightSpatialData.LightPosition.x = light->Displacement.x;
	LightSpatialData.LightPosition.y = light->Displacement.y;
	LightSpatialData.LightPosition.z = light->Displacement.z;
