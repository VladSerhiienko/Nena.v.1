	...
	: public InteractiveTV::Project::Oasis::Home::State
{
	...
	struct AnimationControl
	{
		...
		Nena::Animation::ExponencialOutEasingFunction ResumingAnglularOffset;

		Nena::Animation::LinearEasingFunction ProgressArcProgressSelecting;
		Nena::Animation::LinearEasingFunction ProgressArcProgressDeselecting;
	};
	...
	Button::Color SelectedBorderColor;
