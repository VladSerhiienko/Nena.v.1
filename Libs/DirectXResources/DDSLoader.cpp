	...
	_Outptr_opt_ ID3D11ShaderResourceView** textureView)
{
	...
	case D3D11_RESOURCE_DIMENSION_TEXTURE1D:
	{
											   ...
											   if (SUCCEEDED(hr) && tex != 0)
											   {
												   ...
												   {
													   Assist::SetDebugName(tex, "NenaDDSTextureLoader");
													   //SetDebugObjectName(tex, "NenaDDSTextureLoader");
													   tex->Release();
												   }
											   }
	}
...
HRESULT Nena::Utility::CreateDDSTextureFromMemory(
...
_Use_decl_annotations_
HRESULT Nena::Utility::CreateDDSTextureFromMemoryEx(
	IDirect3DDevice* d3dDevice,
	const uint8_t* ddsData,
	size_t ddsDataSize,
	size_t maxsize,
	...
	)
{
	...
	if (SUCCEEDED(hr))
	{
		...
		{
			Assist::SetDebugName(*texture, "NenaDDSTextureLoader");
			//SetDebugObjectName(*texture, "NenaDDSTextureLoader");
		}

		if (textureView != 0 && *textureView != 0)
		{
			Assist::SetDebugName(*textureView, "NenaDDSTextureLoader");
			//SetDebugObjectName(*textureView, "NenaDDSTextureLoader");
		}
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_
HRESULT Nena::Utility::CreateDDSTextureFromFile(
	IDirect3DDevice* d3dDevice,
...
_Use_decl_annotations_
HRESULT Nena::Utility::CreateDDSTextureFromFileEx(
	IDirect3DDevice* d3dDevice,
	const wchar_t* fileName,
	size_t maxsize,
	D3D11_USAGE usage,
