...
#ifndef __NENA_DIRECTX_MATH_H__
#define __NENA_DIRECTX_MATH_H__
...
// 4x4 Matrix (assumes left-handed cooordinates)
...
namespace std
{
    template<> struct less<Nena::Vector2>
    {
        bool operator()(const Nena::Vector2& V1, const Nena::Vector2& V2) const
        {
            return ( (V1.x < V2.x) || ((V1.x == V2.x) && (V1.y < V2.y)) );
        }
    };

    template<> struct less<Nena::Vector3>
    {
        bool operator()(const Nena::Vector3& V1, const Nena::Vector3& V2) const
        {
            return ( (V1.x < V2.x)
                     || ((V1.x == V2.x) && (V1.y < V2.y))
    ...
    template<> struct less<Nena::Vector4>
    {
        bool operator()(const Nena::Vector4& V1, const Nena::Vector4& V2) const
        {
            return ( (V1.x < V2.x)
                     || ((V1.x == V2.x) && (V1.y < V2.y))
                     || ((V1.x == V2.x) && (V1.y == V2.y) && (V1.z < V2.z))
    ...
    template<> struct less<Nena::Matrix>
    {
        bool operator()(const Nena::Matrix& M1, const Nena::Matrix& M2) const
        {
    ...
    template<> struct less<Nena::Plane>
    {
        bool operator()(const Nena::Plane& P1, const Nena::Plane& P2) const
        {
            return ( (P1.x < P2.x)
                     || ((P1.x == P2.x) && (P1.y < P2.y))
    ...
    template<> struct less<Nena::Quaternion>
    {
        bool operator()(const Nena::Quaternion& Q1, const Nena::Quaternion& Q2) const
        {
            return ( (Q1.x < Q2.x)
                     || ((Q1.x == Q2.x) && (Q1.y < Q2.y))
    ...
    template<> struct less<Nena::Color>
    {
        bool operator()(const Nena::Color& C1, const Nena::Color& C2) const
        {
            return ( (C1.x < C2.x)
                     || ((C1.x == C2.x) && (C1.y < C2.y))
    ...
    template<> struct less<Nena::Ray>
    {
        bool operator()(const Nena::Ray& R1, const Nena::Ray& R2) const
        {
